...
btn_unsharp = QPushButton("Smoothness")
...
row_tools.addWidget(btn_unsharp)
...
class ImageProcessor():
    ...
    def loadImage(self, dir, filename):
       ...
       image_path = os.path.join(dir, filename) #this for importing the folder
...
btn_unsharp.clicked.connect(workimage.do_unsharp)
app.exec()
